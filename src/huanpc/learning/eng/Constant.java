...
/**
 *
 * @author huanpc Khai báo các hằng số sử dụng trong chương trình
 */
public class Constant {

    public static final String DATASET_FOLDER = "./Mail datasets/English";
    ...
    public static final String DATA_TEST_VI[] = {"./Mail datasets/VietNamese/huan/spam",
        "./Mail datasets/VietNamese/huan/ham"};
    public static final String DATA_LEARN_VI[] = {"./Mail datasets/VietNamese/outputMailSpam",
        "./Mail datasets/VietNamese/outputMail"};
    public static final String WORD_TABLE_VI = "learning_vietnamese_words";
